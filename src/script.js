		...
		function getErrorHandler(type) {
			return function() {
				...
				if (writeFile.errorCount === 4) {
					setTimeout(function() {
						alert(
							"Oops! Seems like your preview isn't updating. Please try the following steps until it fixes:\n - Refresh WES Ditor\n - Restart browser\n - Update browser\n - Reinstall WES Ditor (don't forget to export all your creations from saved items pane (click the OPEN button) before reinstalling)\n\nIf nothing works, please tweet out to @wesDitorapp."
						);
